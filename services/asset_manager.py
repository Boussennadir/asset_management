...
class AssetManager:
    ...
    def create(self, eq: Equipement) -> int:
        ...
        self.db.log_action("equipements", "INSERT", new_id, f"Création de l'équipement '{eq.nom}'")
        return new_id
    ...
    def update(self, eq: Equipement):
        ...
        self.db.connection.commit() 
        self.db.log_action("equipements", "UPDATE", eq.id, f"Modification de l'équipement '{eq.nom}'")
    ...
    def delete(self, eq_id: int):
        ...
        self.db.connection.commit() 
        self.db.log_action("equipements", "DELETE", eq_id, f"Suppression de l'équipement '{nom}'")
    ...
    def transfer(self, eq_id: int, new_service_id: int, new_ss_id: Optional[int], motif: str = ""):
        ...
        self.db.execute(
            """INSERT INTO transferts (equipement_id, ancien_service_id, nouveau_service_id,
               ...
               VALUES (?, ?, ?, ?, ?, ?)""",
            (eq_id, eq.service_id, new_service_id,
             eq.sous_service_id, new_ss_id, motif.strip())
        )
        ...
        self.db.connection.commit() 
        self.db.log_action("equipements", "TRANSFER", eq_id,
                           f"Transfert de '{eq.nom}' du service {eq.service_id} vers {new_service_id}")
